...
function Callapi() {
    const jsonUrl = 'https://script.google.com/macros/s/AKfycbxqx9YT3wO0knx0x_ZwEN6Fa-ljFl_EuUt81BIns4LW-vaqZmcrnGVAnroAlPUIoqcJuw/exec';
                                ...
                                <TouchableOpacity
                                    ...
                                    <View style={styles.card}>
                                        ...
                                        <View>
                                            ...
                                            <Text style={styles. wrappedText}>Description: {item.deskripsi}</Text>
                                            <Text>Rate: {item.nilai}</Text>
                                            <Text>Type: {item.kategori}</Text>
